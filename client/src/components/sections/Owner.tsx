  ...
  return (
    <section id="about" className="relative overflow-hidden bg-background py-20 sm:py-24">
      <div
        ...
        style={{ background: "radial-gradient(circle, rgba(91,75,214,0.16), transparent 70%)" }}
      />
      <div className="container relative grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
        ...
        <Reveal className="relative order-2 lg:order-1">
          <div
            ...
            style={{ background: "radial-gradient(60% 60% at 40% 40%, rgba(46,139,230,0.28), transparent 70%)" }}
          />
          <figure className="overflow-hidden rounded-3xl border border-azure/25 shadow-2xl">
            <img
        ...
        <Reveal delay={120} className="order-1 lg:order-2">
          ...
          <ul className="mt-8 space-y-5">
            {VALUES.map(({ icon: Icon, title, desc, chip }) => (
