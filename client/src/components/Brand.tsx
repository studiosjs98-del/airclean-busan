...
export function PhoneButton({ className, size = "md", label = "전화 상담" }: CtaProps) {
  return (
    <a
      ...
      className={cn(
        "inline-flex items-center justify-center gap-2 rounded-xl bg-primary font-semibold text-primary-foreground shadow-[0_6px_24px_-6px_rgba(30,69,171,0.6)] transition-all duration-200 hover:bg-primary-600 hover:shadow-[0_8px_30px_-6px_rgba(30,69,171,0.75)] active:scale-[0.98]",
